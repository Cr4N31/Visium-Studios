...
function HeroText() {
  return (
    ...
    >
      ...
      <motion.div
        className="flex flex-col gap-8 border-t border-white/15 pt-6 md:flex-row md:items-end md:justify-between md:gap-12"
        variants={fadeIn}
      >
        ...
        <div className="flex w-full md:w-auto md:min-w-64">
          <a
            href="/work"
