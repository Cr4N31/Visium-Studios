  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="hero-copy__headline relative w-full text-center text-[clamp(1.7rem,8vw,3.9rem)] md:mt-24 lg:mt-20 sm:mt-16 font-normal leading-[1.06] md:text-[clamp(3rem,5vw,5rem)]">
